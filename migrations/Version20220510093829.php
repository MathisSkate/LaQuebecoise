 ...
 */
final class Version20220510093829 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE detail_achat (id INT AUTO_INCREMENT NOT NULL, matiere_id INT NOT NULL, quantite INT NOT NULL, INDEX IDX_5B594F0FF46CD258 (matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
